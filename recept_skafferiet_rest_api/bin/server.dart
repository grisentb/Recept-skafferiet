...
final _router = shelf_router.Router()
  ...
  ..get('/getRecipeFromCategory/<id>/<sessionToken>/<category>',
      getRecipeFromCategoryHandler)
  ...
  ..post(
      '/updateRating/<userId>/<sessionToken>/<recipeId>', updateRatingHandler)
  ..post('/updateComment/<userId>/<sessionToken>/<recipeId>',
