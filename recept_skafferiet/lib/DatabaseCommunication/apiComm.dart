...
main(List<String> args) async {
  var recipe = new Recipe(
      "Abborre", "ingredients", "instructions", "ext", "url", "por", "img");
  ...
  print(await ApiCommunication.pushRelation(loginResponse['user_id'],
      loginResponse['sessionToken'], recipe.url, null, ""));
...
class ApiCommunication {
  ...
  static const apiAddress = "http://192.168.1.22:8080";
  //Authentication
